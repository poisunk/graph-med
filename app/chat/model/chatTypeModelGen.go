...
var prefixChatTypeCacheKey = "cache:chatType:"
...
func newDefaultChatTypeModel(conn *monc.Model) *defaultChatTypeModel {
...
func (m *defaultChatTypeModel) Insert(ctx context.Context, data *ChatType) error {
	...
	key := prefixChatTypeCacheKey + data.ID.Hex()
