...
const (
	Usercenter_Login_FullMethodName         = "/pd.Usercenter/login"
	Usercenter_Register_FullMethodName      = "/pd.Usercenter/register"
	Usercenter_GetUserInfo_FullMethodName   = "/pd.Usercenter/getUserInfo"
	Usercenter_GenerateToken_FullMethodName = "/pd.Usercenter/generateToken"
)
