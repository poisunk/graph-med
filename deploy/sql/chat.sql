...
CREATE TABLE `chat_dialogue` (
    ...
    `parent_dialogue_id` int(11) DEFAULT NULL COMMENT '父ID',
    ...
    INDEX `idx_user_id` (`user_id`),
    FOREIGN KEY (`parent_dialogue_id`) REFERENCES `chat_dialogue` (`dialogue_id`),
    FOREIGN KEY (`chat_session_id`) REFERENCES `chat_session` (`session_id`)
...
CREATE TABLE `chat_message` (
    ...
    PRIMARY KEY (`id`),
    INDEX `idx_dialogue_id` (`dialogue_id`),
    FOREIGN KEY (`dialogue_id`) REFERENCES `chat_dialogue` (`dialogue_id`)
